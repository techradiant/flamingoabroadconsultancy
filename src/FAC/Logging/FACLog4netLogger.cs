...
namespace FAC.Logging {
    [Serializable]
    public class FACLog4netLogger : MarshalByRefObject, Logger {
        private static readonly Type declaringType = typeof(FACLog4netLogger);       

        public FACLog4netLogger(log4net.Core.ILogger logger, FACLog4netFactory factory) {           
            Logger = logger;
            Factory = factory;
        }

        internal FACLog4netLogger() {
        }

        internal FACLog4netLogger(ILog log, FACLog4netFactory factory)
        ...
        protected internal FACLog4netFactory Factory { get; set; }
